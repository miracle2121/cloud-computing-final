...
public class S3LocalDrive {
    ...
    public void start() throws Exception {
        ...
        int watchId = JNotify.addWatch(driveDir, mask, true, new DirectoryListener(this));
        S3PollingService pollService = new S3PollingService(this);
    ...
    public static void main(String[] args) throws Exception {
        ...
        prop.load(new FileInputStream(new File("AwsCredentials.properties")));
